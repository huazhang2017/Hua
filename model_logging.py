...
class Logger:
    ...
    def log_loss(self, current_step):
        ...
        if self.file:
            self.file.write("loss at step " + str(current_step) + ": " + str(avg_loss) + '\n')
            #print("loss at step " + str(current_step) + ": " + str(avg_loss), self.file)


    def validate(self, current_step):
        avg_loss, avg_accuracy, avg_accuracy_loss = self.trainer.validate()
        print("validation loss: " + str(avg_loss))
        print("validation accuracy: " + str(avg_accuracy * 100) + "%")
        print("validation accuracy loss: " + str(avg_accuracy_loss))
        if self.file:
            self.file.write("validation loss: " + str(avg_loss) + '\n' + "validation accuracy: " + str(avg_accuracy * 100)  + "validation accuracy loss: " + str(avg_accuracy_loss) + "%\n" )
            #print("validation loss: " + str(avg_loss), self.file)
            #print("validation accuracy: " + str(avg_accuracy * 100) + "%", self.file)
